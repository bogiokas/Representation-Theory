...
\usepackage{fancyhdr} %control of footers/headers
 \pagestyle{fancy} %define default page style
  ...
  \fancyhead[RE]{\textit{Representation Theory}}
...
\NewDocumentCommand\GL{mgg}{
  \mathrm{GL}\IfNoValueTF{#2}{}{_{#2}}\left(#1\right)
}
\newcommand\twocols[4]{\left(\begin{array}{cc}#1&#3\\#2&#4\\\end{array}\right)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%  OTHER NOTATIONS  %%%%%%%%%%%%%%%%%%%%%%%
...
\newtheorem{remarks}[common]{Remarks}
\newtheorem{note}[common]{Note}
\newtheorem{notes}[common]{Notes}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%  MAKE TITLE  %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{\vspace{-30pt}\rule{320pt}{0.5mm}\\\vspace{10pt}Representation theory of finite groups\\\rule{320pt}{0.5mm}}
\date{}
\author{}
\date{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\tableofcontents
%main document
\include{chapters/first_definitions}
\end{document}
